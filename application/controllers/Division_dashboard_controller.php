...
public function index() {
    ...
    // Get nutritional data for entire division with assessment type filter
    $data['nutritional_data'] = $this->division_dashboard_model->get_division_nutritional_data($assessment_type);
    $data['grand_total'] = $this->division_dashboard_model->get_division_grand_total($assessment_type);
    ...
    // Set overall stats - THIS IS WHAT YOUR VIEW USES
    $data['overall_stats'] = [
    ...
    // Load the full-page division dashboard view directly (it includes its own head/footer)
