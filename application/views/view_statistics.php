                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <span class="fw-bold text-danger">
                      <?php echo $total_severely_wasted ?? 0; ?> 
                      (<?php echo $total_students > 0 ? round(($total_severely_wasted / $total_students) * 100, 1) : 0; ?>%)
                    </span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" 
                         style="width: <?php echo $total_students > 0 ? ($total_severely_wasted / $total_students * 100) : 0; ?>%">
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <span class="fw-bold text-warning">
                      <?php echo $total_wasted ?? 0; ?> 
                      (<?php echo $total_students > 0 ? round(($total_wasted / $total_students) * 100, 1) : 0; ?>%)
                    </span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar bg-warning" role="progressbar" 
                         style="width: <?php echo $total_students > 0 ? ($total_wasted / $total_students * 100) : 0; ?>%">
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <span class="fw-bold text-success">
                      <?php echo $total_normal ?? 0; ?> 
                      (<?php echo $total_students > 0 ? round(($total_normal / $total_students) * 100, 1) : 0; ?>%)
                    </span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar bg-success" role="progressbar" 
                         style="width: <?php echo $total_students > 0 ? ($total_normal / $total_students * 100) : 0; ?>%">
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <span class="fw-bold text-info">
                      <?php echo $total_overweight ?? 0; ?> 
                      (<?php echo $total_students > 0 ? round(($total_overweight / $total_students) * 100, 1) : 0; ?>%)
                    </span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar bg-info" role="progressbar" 
                         style="width: <?php echo $total_students > 0 ? ($total_overweight / $total_students * 100) : 0; ?>%">
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <span class="fw-bold text-primary">
                      <?php echo $total_obese ?? 0; ?> 
                      (<?php echo $total_students > 0 ? round(($total_obese / $total_students) * 100, 1) : 0; ?>%)
                    </span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar bg-primary" role="progressbar" 
                         style="width: <?php echo $total_students > 0 ? ($total_obese / $total_students * 100) : 0; ?>%">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row g-3">
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-danger h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-danger"><?php echo $total_severely_wasted ?? 0; ?></div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-warning h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-warning"><?php echo $total_wasted ?? 0; ?></div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-success h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-success"><?php echo $total_normal ?? 0; ?></div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-info h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-info"><?php echo $total_overweight ?? 0; ?></div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-primary h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-primary"><?php echo $total_obese ?? 0; ?></div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="card border-left-secondary h-100">
                      <div class="card-body text-center py-3">
                        <div class="h4 mb-0 fw-bold text-secondary"><?php echo $total_students ?? 0; ?></div>
