...
<html lang="en">
  <head>
    ...
    <title>Nutritional Assessment Reports - District</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css">
    <link rel="icon" href="<?= base_url('favicon.ico'); ?>">
    <link rel="stylesheet" href="<?= base_url(ASSETS_PATH . '/css/district-reports.css'); ?>">
  </head>
  <body class="bg-light">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="card border mb-4">
                ...
                <div class="card-body">
                  <form method="get" action="<?php echo site_url('district/reports'); ?>" class="row g-3" id="filterForm">
                    <div class="col-md-3">
              ...
              <div class="card-body">
                  <?php if (empty($reports)): ?>
                      <div class="text-center py-5" id="noReportsMessage">
                          ...
                          <a href="<?php echo site_url('district/reports'); ?>" class="btn btn-primary" id="clearFiltersBtn">
    ...
    <script>
        window.districtReportsConfig = {
            totalReports: <?php echo count($reports); ?>,
            currentFilters: <?php echo json_encode($current_filters); ?>,
            baseUrl: '<?php echo site_url('district/reports'); ?>',
            hasReports: <?php echo !empty($reports) ? 'true' : 'false'; ?>
        };
    </script>
    
    <script src="<?= base_url(ASSETS_PATH . '/js/district-reports.js'); ?>"></script>
  </body>
</html>