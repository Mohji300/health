...
<html lang="en">
  <head>
    ...
    <title>Nutritional Assessment Reports - Division</title>
    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper" class="w-100">
        <div class="container-fluid py-4">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php echo number_format($midline_count); ?>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <form method="get" action="<?php echo site_url('division/reports'); ?>" class="row g-3" id="filterForm">
                    <div class="col-md-3">
                      ...
                      <select name="legislative_district" class="form-select" id="legislativeDistrictFilter">
                    ...
                    <div class="col-md-3">
                      ...
                      <select name="school_district" class="form-select" id="schoolDistrictFilter">
                    ...
                    <div class="col-md-3">
                      ...
                      <select name="school_name" class="form-select" id="schoolNameFilter">
          ...
          <?php if (!empty($current_filters['legislative_district']) || !empty($current_filters['school_district']) || !empty($current_filters['school_name']) || !empty($current_filters['grade_level']) || !empty($current_filters['assessment_type']) || !empty($current_filters['date_from']) || !empty($current_filters['date_to'])): ?>
          <div class="alert alert-info alert-dismissible fade show mb-4" role="alert">
            <i class="fas fa-filter me-2"></i>
            <strong>Active Filters:</strong>
            <?php if (!empty($current_filters['legislative_district'])): ?>
              <span class="badge bg-primary ms-1">Legislative District: <?= htmlspecialchars($current_filters['legislative_district']) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['school_district'])): ?>
              <span class="badge bg-success ms-1">School District: <?= htmlspecialchars($current_filters['school_district']) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['school_name'])): ?>
              <span class="badge bg-info ms-1">School: <?= htmlspecialchars($current_filters['school_name']) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['grade_level'])): ?>
              <span class="badge bg-warning ms-1">Grade: <?= htmlspecialchars($current_filters['grade_level']) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['assessment_type'])): ?>
              <span class="badge bg-secondary ms-1">Type: <?= ucfirst(htmlspecialchars($current_filters['assessment_type'])) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['date_from'])): ?>
              <span class="badge bg-dark ms-1">From: <?= htmlspecialchars($current_filters['date_from']) ?></span>
            <?php endif; ?>
            <?php if (!empty($current_filters['date_to'])): ?>
              <span class="badge bg-dark ms-1">To: <?= htmlspecialchars($current_filters['date_to']) ?></span>
            <?php endif; ?>
              ...
              <div class="card-body">
                  <?php if (empty($reports)): ?>
                      <div class="text-center py-5" id="noReportsMessage">
                          ...
                          <button type="button" class="btn btn-primary" id="clearFiltersBtnNoReports">
                          ...
                          <table class="table table-bordered table-hover" id="reportsTable" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                  ...
                                  <?php 
                                      ...
                                      $assessment_icon = ($report->assessment_type == 'baseline') ? 'flag' : (($report->assessment_type == 'midline') ? 'flag' : 'flag-checkered');
                                  ?>
                                  <tr>
