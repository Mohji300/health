...
$(document).ready(function() {
    ...
    function clearAllFilters() {
        ...
        if (reportsConfig && reportsConfig.baseUrl) {
            window.location.href = reportsConfig.baseUrl;
        } else {
    ...
    function preserveFilterValues() {
        if (reportsConfig && reportsConfig.currentFilters) {
            const filters = reportsConfig.currentFilters;
